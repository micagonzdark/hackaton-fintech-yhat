...
('host_solidity', 'prior_credit_behavior', 'Créditos previos', 10, 'Repago de líneas anteriores en la plataforma.'),
...
('property_quality', 'calendar_availability', 'Disponibilidad calendario', 10, 'Dias disponibles para generar repago.'),
...
('income_history', 'revenue_volatility', 'Volatilidad', 20, 'Menor volatilidad mejora límite crediticio.'),
...
('future_bookings', 'payout_schedule', 'Fechas de payout', 15, 'Cuánto tarda en recuperarse la línea.'),
...
('H001', 'host_solidity', 96, '8.7 años, 486 reservas y dos créditos previos repagados.'),
...
('H003', 'host_solidity', 77, 'Historial suficiente, sin créditos previos.'),
('H003', 'property_quality', 84, 'Propiedad solida y habilitada en destino de demanda estable.'),
...
('H005', 'host_solidity', 88, '6.5 años, 342 reservas y un crédito repagado.'),
...
('O001', 'H001', 2800000, 89.0, 'bajo', 'approved', 11800000, 3200000, 2500000, 10.0, 28.0, 3, 'repago probable', 'repago con extensión', 'Host histórico con alta reputación y reservas fuertes de invierno.', '2026-06-05'),
('O002', 'H002', 1800000, 75.4, 'medio', 'approved', 5200000, 1700000, 1150000, 14.0, 32.0, 4, 'repago probable', 'riesgo parcial', 'Buena temporada futura, pero destino muy estacional y reservas lejanas.', '2026-06-05'),
('O003', 'H003', 1000000, 77.2, 'medio_bajo', 'approved', 4100000, 1200000, 700000, 12.0, 22.0, 3, 'repago probable', 'repago probable con menor margen', 'Buen perfil, aunque la necesidad de smoothing es menor.', '2026-06-05'),
...
('O005', 'H005', 900000, 79.8, 'medio_bajo', 'approved', 3600000, 950000, 500000, 11.0, 18.0, 2, 'repago probable', 'repago probable', 'Host excelente, pero ingresos urbanos estables reducen necesidad estacional.', '2026-06-05'),
